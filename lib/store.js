...
//   failwatch: 降级保护状态（备用模型配置 + 当前降级态）
//   usage: 消耗量监测基线（上次统计位置）
...
function defaultStore() {
  return { version: STORE_VERSION, hidden: {}, failwatch: null, usage: null };
}
...
export function readStore(dataDir) {
  try {
    ...
    return {
      ...
      failwatch: parsed.failwatch && typeof parsed.failwatch === "object" ? parsed.failwatch : null,
